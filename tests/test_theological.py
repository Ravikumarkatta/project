...
def validator(config_file, monkeypatch):
    ...
    monkeypatch.setattr(TheologicalValidator, "_initialize_rules", mock_initialize_rules)
...
def test_theological_embeddings(validator):
    ...
    assert similarity.item() > 0.7  # Similar theological statements should have high similarity