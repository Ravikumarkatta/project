...
class TheologicalLoss(nn.Module):
    ...
    def __init__(self, config: Optional[Dict] = None):
        ...
        self.config = config or {
            ...
            "auxiliary_losses": {
                "verse_detection": {"loss_type": "cross_entropy", "weight": 0.3},
                "theological_accuracy": {"loss_type": "kl_divergence", "weight": 0.5},
            },
        }
    ...
    def forward(
        ...
        if theological_logits is not None and theological_labels is not None:
            ...
            if theo_loss_config["loss_type"] == "kl_divergence":
                ...
                theo_loss = F.kl_div(
                    theo_probs.log(), theological_labels, reduction="batchmean"
                )
